...
import static com.coinwallet.common.web3j.api.EtherScanApi.getNonceForAddress;
...
public class TransactionOnNode {
    ...
    public static String transactionOnContract(Web3j web3j, ECKeyPair ecKeyPair, String OCNAmount, String toAddress, String gas_price, String gas_limit, String data, String ERC20Address) throws IOException, InterruptedException {
        ...
        if (ethSendTransaction == null ||ethSendTransaction.getTransactionHash()==null) {
            logger.warn("node transfer is null ：Txhash is null ，result is ："+ JSON.toJSONString(ethSendTransaction)+
                    "\n ,send param：gas_price"+gas_price+" gas_limit:"+gas_limit+" OCNAmount:"+OCNAmount+
           "\n fromAddress:"+ walletAddress+" toAddress:"+toAddress+" nonce="+nonce);
        }
